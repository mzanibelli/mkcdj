...
var (
	...
	b = [...]string{"ffmpeg", "-v", "quiet", "-i", "pipe:0", "-f", "wav", "-ac", "2", "-ar", "44100", "-acodec", "pcm_s16le", "pipe:1"}
...
func AudioCD(ctx context.Context) *exec.Cmd     { return exec.CommandContext(ctx, b[0], b[1:]...) } //nolint:gosec
